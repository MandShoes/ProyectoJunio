  ...
  <form>
    <fieldset>
      ...
      <div class="mb-3">
        ...
        <input type="text" name="nombre" class="form-control" value="<%= currentUser.getNombre() %>">
      </div>
      <div class="mb-3">
        <label for="contrasena" class="form-label">Password</label>
        <input type="password" name="contrasena" class="form-control" value="<%= currentUser.getContrasena() %>">
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="direccion" class="form-control" value="<%= currentUser.getDireccion() %>">
      </div>
    </fieldset>
